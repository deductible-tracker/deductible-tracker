const CACHE_NAME='dt-cache-bf50d28b5834';function createOfflineResponse(){const offlineHtml=`
        <!doctype html>
        <html lang="en">
        <head>
            <meta charset="utf-8">
