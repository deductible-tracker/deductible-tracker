((e, t) => {
  ...
  function N(t, n) {
    ('function' == typeof n && (n = n(F(t))),
      ('undefined' == typeof Reflect ? O : Reflect.ownKeys)(n).forEach(function (e) {
        u(t, e, n[e]);
      }));
  }
  ...
  function ee(e) {
    ...
    e = (function e(t) {
      ...
      if (x(t)) {
        ...
        var i,
          a = F(t);
        for (i in ((n = a === Object.prototype ? {} : Object.create(a)), Z.set(t, n), t))
          m(t, i) && (n[i] = e(t[i]));
      }
      return n;
    })(e);
  ...
  e = t.reduce(function (e, t) {
    return (-1 === ['Syntax', 'Type', 'Range'].indexOf(t) && (e[t + 'Error'] = k[t]), e);
  }, {});
  function g() {}
  function ve(e) {
    return e;
    ...
    return o === g
      ...
      : function () {
          var e = o.apply(this, arguments),
            ...
            n = this.onerror,
            r = ((this.onsuccess = null), (this.onerror = null), i.apply(this, arguments));
          return (
      ...
      'undefined' == typeof Promise
        ...
        : ((t = Promise.resolve()),
          'undefined' != typeof crypto && crypto.subtle
            ? [(Ee = crypto.subtle.digest('SHA-512', new Uint8Array([0]))), F(Ee), t]
            : [t, F(t), t]),
    t = Ee[0],
    Se = Ee[1],
    Se = Se && Se.then,
    ...
    ((t ? !i.echoes || (Ze++ && e === P) : !Ze || (--Ze && e === P)) ||
      queueMicrotask(
        t
          ? function (e) {
              (++et,
                (i.echoes && 0 != --i.echoes) || (i.echoes = i.awaits = i.id = 0),
                Je.push(P),
                h(e, !0));
            }.bind(null, e)
          : ot
  ...
  var vt = { type: 3, lower: -1 / 0, lowerOpen: !1, upper: [[]], upperOpen: !1 };
  function mt(t) {
  ...
  function j(e, t) {
    try {
      ...
      switch (n) {
        ...
        case 'binary':
          for (
            var o = wt(e), i = wt(t), a = o.length, u = i.length, s = a < u ? a : u, c = 0;
            c < s;
            ++c
          )
  ...
  ((r.prototype._trans = function (e, r, t) {
          ...
          : (function t(n, r, o, i) {
              if (n.idbdb && (n._state.openComplete || P.letThrough || n._vip)) {
                ...
                try {
                  ...
                  return e.name === de.InvalidState && n.isOpen() && 0 < --n._state.PR1398_maxLoop
    ...
    (r.prototype.update = function (e, t) {
      return 'object' != typeof e || x(e)
        ...
        : void 0 === (e = c(e, this.schema.primKey.keyPath))
          ? w(new k.InvalidArgument('Given object does not contain its primary key'))
          : this.where(':id').equals(e).modify(t);
    }),
    ...
    (r.prototype.clear = function () {
      var t = this;
      return this._trans('readwrite', function (e) {
        return t.core.mutate({ trans: e, type: 'deleteRange', range: vt }).then(function (e) {
          return _t(t, null, e);
        });
      }).then(function (e) {
        return e.numFailures ? K.reject(e.failures[0]) : void 0;
    ...
    (r.prototype.bulkAdd = function (o, e, t) {
      ...
      return this._trans('readwrite', function (e) {
        ...
        if (a && a.length !== o.length)
          throw new k.InvalidArgument('Arguments objects and keys must have the same length');
        var r = o.length,
          n = t && n ? o.map(mt(t)) : o;
        return i.core
          ...
          .then(function (e) {
            ...
            throw new he(
              ''.concat(i.name, '.bulkAdd(): ').concat(t, ' of ').concat(r, ' operations failed'),
              n
            );
          });
      });
      ...
      return this._trans('readwrite', function (e) {
        ...
        return i.core
          ...
          .then(function (e) {
            ...
            if (0 === t) return u ? e.results : e.lastResult;
            throw new he(
              ''.concat(i.name, '.bulkPut(): ').concat(t, ' of ').concat(r, ' operations failed'),
              n
            );
          });
      });
                ...
                if (o) {
                  for (var i = 0, a = Object.keys(r); i < a.length; i++) {
                    ...
                    if (u === h.schema.primKey.keyPath) {
                      if (0 !== j(s, n))
                        throw new k.Constraint('Cannot update primary key in bulkUpdate()');
                    } else b(o, u, s);
                  }
    ...
    (r.prototype.bulkDelete = function (t) {
      var r = this,
        o = t.length;
      return this._trans('readwrite', function (e) {
        return r.core.mutate({ trans: e, type: 'delete', keys: t }).then(function (e) {
          return _t(r, t, e);
        });
      }).then(function (e) {
        var t = e.numFailures,
        ...
        throw new he(
          ''.concat(r.name, '.bulkDelete(): ').concat(t, ' of ').concat(o, ' operations failed'),
          n
        );
      });
    }));
  ...
  ((o.prototype._read = function (e, t) {
    ...
    (o.prototype.count = function (e) {
      ...
      return this._read(function (e) {
        ...
        return St(n, !0)
          ? r
              .count({ trans: e, query: { index: Ct(n, r.schema), range: n.range } })
              .then(function (e) {
      ...
      return this._read(function (e) {
        ...
        return 'next' === o.dir && St(o, !0) && 0 < o.limit
          ? ((t = o.valueMapper),
            ...
            o.table.core
              .query({ trans: e, limit: o.limit, values: !0, query: { index: n, range: o.range } })
              .then(function (e) {
                e = e.result;
                return t ? e.map(t) : e;
              }))
    ...
    (o.prototype.modify = function (x) {
      ...
      return this._write(function (p) {
        ...
        var v =
          ...
          a = (e && (w = 'object' == typeof e ? e[m.name] || e['*'] || 200 : e), []),
          u = 0,
          t = [],
          _ = x === Bt;
        return n
          ...
          .then(function (f) {
            function h(s) {
              var c = Math.min(w, f.length - s),
                l = f.slice(s, s + c);
              return (
                _ ? Promise.resolve([]) : m.getMany({ trans: p, keys: l, cache: 'immutable' })
              ).then(function (e) {
                var n = [],
                  t = [],
                  r = b ? [] : null,
                ...
                return Promise.resolve(
                  0 < n.length &&
                    m.mutate({ trans: p, type: 'add', values: n }).then(function (e) {
            ...
            var d = St(k) &&
              k.limit === 1 / 0 &&
              ('function' != typeof x || _) && { index: k.index, range: k.range };
  ...
  var zt = 'storagemutated',
    ...
    $t =
      ...
      (p.prototype.abort = function () {
        this.active &&
          ((this.active = !1), this.idbtrans && this.idbtrans.abort(), this._reject(new k.Abort()));
      }),
      (p.prototype.table = function (e) {
        ...
        var n = this.schema[e];
        if (n)
          return (((n = new this.db.Table(e, n, this)).core = this.db.core.table(e)), (t[e] = n));
        ...
        mutate: function (e) {
          ...
          return new Promise(function (t, e) {
            ...
            if ('deleteRange' === v) {
              ...
              if (o)
                for (var d = 0; d < a; ++d)
                  (s.push((i = h && void 0 !== h[d] ? n[v](f[d], h[d]) : n[v](f[d]))),
                    (i.onerror = u));
        ...
        query:
          ...
          function (f) {
            return new Promise(function (n, e) {
              ...
              h
                ? (((s = a ? t.getAll(l, c) : t.getAllKeys(l, c)).onsuccess = function (e) {
                    return n({ result: e.target.result });
                  }),
                  (s.onerror = T(e)))
                : ((r = 0),
                  (o = !a && 'openKeyCursor' in t ? t.openKeyCursor(l) : t.openCursor(l)),
                  (i = []),
        ...
        openCursor: function (e) {
          ...
          return new Promise(function (t, n) {
            ...
            var e = a.index,
              ...
              s = !i && 'openKeyCursor' in o ? o.openKeyCursor(_(r), e) : o.openCursor(_(r), e);
            ((s.onerror = T(n)),
        ...
        (!t || ('value' in t && void 0 === t.value)) &&
          (e === o.Transaction.prototype || e instanceof o.Transaction
            ? u(e, n, {
                ...
                set: function (e) {
                  L(this, n, { value: e, writable: !0, configurable: !0, enumerable: !0 });
                },
              })
            : (e[n] = new o.Table(n, r)));
      });
                ...
                : (e.forEach(function (u) {
                    (t.push(function () {
                      var t,
                        ...
                        o = h,
                        e = u._cfg.dbschema,
                        i = (vn(s, o, f), vn(s, e, f), (h = s._dbSchema = e), fn(o, e)),
                        a =
                          ...
                          i.change.forEach(function (e) {
                            if (e.recreate)
                              throw new k.Upgrade('Not yet support for changing primary key');
                      ...
                      t.push(function (e) {
                        ...
                        ((t = r),
                          ...
                          un(s, [s.Transaction.prototype]),
                          an(s, [s.Transaction.prototype], s._storeNames, s._dbSchema),
      ...
      W(t.objectStoreNames, 0).forEach(function (e) {
        for (
          ...
          var i = t.index(t.indexNames[o]),
            a = i.keyPath,
            i = Qt(i.name, a, !!i.unique, !!i.multiEntry, !1, a && 'string' != typeof a, !1);
          r.push(i);
        }
        s[e] = Xt(e, n, r);
      }),
  ...
  ((gn.prototype._createTableSchema = Xt),
      ...
      O(r).forEach(function (e) {
        if (null !== r[e]) {
          ...
          t.forEach(function (e) {
            ...
            if (!e.keyPath)
              throw new k.Schema('Index must have a name and cannot be an empty string');
          });
    ...
    (gn.prototype.stores = function (e) {
      ...
      return (
        ...
        an(t, [t._allTables, t, t.Transaction.prototype, this._cfg.tables], O(r), r),
        (t._storeNames = O(r)),
        this
      );
    }),
  ...
  function wn(e, t) {
    ...
    return (
      n ||
        (n = e._dbNamesDB = new q(ht, { addons: [], indexedDB: e, IDBKeyRange: t }))
          .version(1)
          .stores({ dbnames: 'name' }),
      n.table('dbnames')
    );
  ...
  function On(e, t, n) {
    ...
    if (!isNaN(r)) {
      ...
      var r = e.l,
        o = e.r;
      if (j(n, e.from) < 0)
        return (r ? On(r, t, n) : (e.l = { from: t, to: n, d: 1, l: null, r: null }), Sn(e));
      if (0 < j(t, e.to))
        return (o ? On(o, t, n) : (e.r = { from: t, to: n, d: 1, l: null, r: null }), Sn(e));
      (j(t, e.from) < 0 && ((e.from = t), (e.l = null), (e.d = o ? o.d + 1 : 1)),
        0 < j(n, e.to) && ((e.to = n), (e.r = null), (e.d = e.l ? e.l.d + 1 : 1)));
      t = !e.r;
  ...
  function Kn(e, t) {
    var n = En(t),
      r = n.next();
    if (!r.done)
      for (var o = r.value, i = En(e), a = i.next(o.from), u = a.value; !r.done && !a.done; ) {
      ...
      next: function (e) {
        for (var t = 0 < arguments.length; n; )
          switch (n.s) {
            case 0:
              if (((n.s = 1), t))
                for (; n.n.l && j(e, n.n.from) < 0; ) n = { up: n, n: n.n.l, s: 1 };
              else for (; n.n.l; ) n = { up: n, n: n.n.l, s: 1 };
            case 1:
              if (((n.s = 2), !t || j(e, n.n.to) <= 0)) return { value: n.n, done: !1 };
            case 2:
              if (n.n.r) {
  ...
  function Sn(e) {
    var t,
      n,
      r,
      o = ((null == (o = e.r) ? void 0 : o.d) || 0) - ((null == (o = e.l) ? void 0 : o.d) || 0),
      o = 1 < o ? 'r' : o < -1 ? 'l' : '';
    (o &&
      ((t = 'r' == o ? 'l' : 'r'),
      (n = _({}, e)),
        ...
        t[e]
          ...
          : (t[e] = (function e(t) {
              ...
              for (n in t)
                m(t, n) &&
                  ((r = t[n]),
                  (o[n] = !r || 'object' != typeof r || J.has(r.constructor) ? r : e(r)));
              return o;
            })(n[e]));
      }),
      t
    ...
    if (e.all) for (var r = 0, o = Object.values(Tn); r < o.length; r++) Rn((u = o[r]), e, n, t);
      ...
      for (var i in e) {
        var a,
          ...
          i = /^idb\:\/\/(.*)\/(.*)\//.exec(i);
        i &&
          ((a = i[1]), (i = i[2]), (u = Tn['idb://'.concat(a, '/').concat(i)])) &&
          Rn(u, e, n, t);
      }
          ...
          b &&
            ...
            h.tables.forEach(function (t) {
              (t.schema.indexes.forEach(function (e) {
                e.name &&
                  (n['idb://'.concat(h.name, '/').concat(t.name, '/').concat(e.name)] = new I(
                    -1 / 0,
                    [[[]]]
                  ));
              }),
              ...
              function n(n) {
                return Object.create(n, {
                  continue: {
                    value: function (e) {
                      null != e
                        ? n.continue(Nn(e, t.reverse ? l.MAX_KEY : l.MIN_KEY, r))
                        : t.unique
                          ? n.continue(
                              n.key.slice(0, o).concat(t.reverse ? l.MIN_KEY : l.MAX_KEY, r)
                            )
                          : n.continue();
                    },
                  },
                  ...
                  return t._promise(
                    ...
                    function () {
                      return (function n(r, o, i) {
                        return y
                          .query({ trans: r, values: !1, query: { index: v, range: o }, limit: i })
                          .then(function (e) {
                            var t = e.result;
                            return a({ type: 'delete', keys: t, trans: r }).then(function (e) {
                              return 0 < e.numFailures
                                ...
                                : t.length < i
                                  ...
                                  : n(r, _(_({}, o), { lower: t[t.length - 1], lowerOpen: !0 }), i);
                            });
                          });
                      })(e.trans, e.range, 1e4);
                    },
              ...
              function a(c) {
                ...
                if (f)
                  return (
                    'delete' !==
                      (c =
                        'add' === c.type || 'put' === c.type ? _(_({}, c), { keys: f }) : _({}, c))
                        .type && (c.values = R([], c.values, !0)),
                          ...
                          'delete' === c.type
                            ...
                            : 'add' === c.type || void 0 === i
                              ? ((n = d.fire.call(a, e, c.values[t], l)),
                                null == e &&
                                  null != n &&
                                  ((c.keys[t] = e = n), v.outbound || b(c.values[t], v.keyPath, e)))
                              : ((n = Un(i, c.values[t])),
                        ...
                        .then(function (e) {
                          for (
                            ...
                            null == i
                              ...
                              : a.onsuccess &&
                                a.onsuccess('put' === c.type && u[o] ? c.values[o] : i);
                          }
  ...
  function Wn(e, t, n) {
    try {
      ...
      for (var r = [], o = 0, i = 0; o < t.keys.length && i < e.length; ++o)
        0 === j(t.keys[o], e[i]) && (r.push(n ? ee(t.values[o]) : t.values[o]), ++i);
        ...
        transaction: function (e, t, n) {
          if (P.subscr && 'readonly' !== t)
            throw new k.ReadOnly(
              'Readwrite transaction in liveQuery context. Querier source: '.concat(P.querier)
            );
            ...
            n = _(_({}, p), {
              mutate: function (a) {
                ...
                return (
                  x(f)
                    ? (r.addKeys(f),
                      (c = 'delete' === c || f.length === l.length ? Wn(f, h) : null) ||
                        o.addKeys(f),
                      (c || l) &&
                        ((e = u),
                        (i = c),
              ...
              n[s] = function (o) {
                ...
                if (t) {
                  var i,
                    ...
                    t = t[1];
                  if (
                    (('query' === s && r.isPrimaryKey && !o.values ? u : e(r.name || '')).add(t),
                    !r.isPrimaryKey)
                  ) {
                    if ('count' !== s)
                      return (
                        (i =
                          'query' === s && l && o.values && p.query(_(_({}, o), { values: !1 }))),
  ...
  function Xn(e, t, n) {
    ...
    return 0 === n.numFailures
      ? t
      : 'deleteRange' === t.type ||
          ((r = t.keys ? t.keys.length : 'values' in t && t.values ? t.values.length : 1),
          n.numFailures === r)
        ? null
        : ((r = _({}, t)),
          x(r.keys) &&
  ...
  function Hn(e, t) {
    return (
      (n = e),
      (void 0 === (r = t).lower || (r.lowerOpen ? 0 < j(n, r.lower) : 0 <= j(n, r.lower))) &&
        ((n = e),
        void 0 === (r = t).upper || (r.upperOpen ? j(n, r.upper) < 0 : j(n, r.upper) <= 0))
    );
    var n, r;
  }
                      ...
                      for (var t = new Set(), e = 0, n = g; e < n.length; e++) {
                        ...
                        if (o) {
                          ...
                          if (x._explicit && b && x.mutatedParts)
                            for (var u = 0, s = Object.values(o.queries.query); u < s.length; u++)
                            ...
                            for (var f = 0, h = Object.values(o.queries.query); f < h.length; f++)
                                  ...
                                  (b && !p.dirty
                                    ? ((y = Object.isFrozen(p.res)),
                                      ...
                                      p.dirty
                                        ...
                                        : y !== p.res &&
                                          ((p.res = y), (p.promise = K.resolve({ result: y }))))
                                    : (p.dirty && ie(d, p),
                                      p.subscribers.forEach(function (e) {
                                        return t.add(e);
                                      })));
          ...
          return _(_({}, c), {
            ...
            query: function (t) {
              ...
              return $n(P, c) && Qn('query', t)
                ? ((o = 'immutable' === (null == (n = P.trans) ? void 0 : n.db._options.cache)),
                  (e = (n = P).requery),
                  (n = n.signal),
                  (a = ((e, t, n, r) => {
                  ...
                  u.promise.then(function (e) {
                    return {
                      result: Jn(e.result, t, null == r ? void 0 : r.optimisticOps, c, u, o),
                    };
                  }))
                : c.query(t);
            },
  ...
  ((D.prototype.version = function (t) {
      ...
      return new K(function (r, t) {
        function e() {
          ...
          ((e.onsuccess = E(function () {
            ...
            ((e = o._deps),
              (t = o.name),
              _n((n = e.indexedDB)) || t === ht || wn(n, e.IDBKeyRange).delete(t).catch(g),
              r());
          })),
            (e.onerror = T(t)),
    ...
    (D.prototype._transaction = function (e, t, n) {
      var r,
        ...
        i = this,
        a = P.trans,
        u = ((a && a.db === this && -1 === e.indexOf('!')) || (a = null), -1 !== e.indexOf('?'));
      e = e.replace('!', '').replace('?', '');
      try {
        if (
          ((o = t.map(function (e) {
          ...
          (a &&
            o.forEach(function (e) {
              if (a && -1 === a.storeNames.indexOf(e)) {
                if (!u)
                  throw new k.SubTransaction('Table ' + e + ' not included in parent transaction.');
                a = null;
              }
            }),
            u && a && !a.active && (a = null));
        ...
        return K.resolve().then(function () {
          ...
          if (s) t.idbtrans = s.idbtrans;
            ...
            try {
              ...
              return e.name === de.InvalidState && i.isOpen() && 0 < --i._state.PR1398_maxLoop
                ? (console.warn('Dexie: Need to reopen db'),
              ...
              K.follow(function () {
                ...
                (n = c.call(t, t)) &&
                  (r
                    ...
                    : 'function' == typeof n.next && 'function' == typeof n.throw && (n = Mn(n)));
              }, e));
          return (
            n && 'function' == typeof n.then
  ...
  function D(e, t) {
    var i,
      ...
      l =
        ...
        (this._state = c),
        (this.name = e),
        (this.on = Kt(this, 'populate', 'blocked', 'versionchange', 'close', { ready: [ke, g] })),
        ...
        this.on('blocked', function (e) {
          !e.newVersion || e.newVersion < e.oldVersion
            ...
            : console.warn(
                "Upgrade '"
                  .concat(u.name, "' blocked by other connection holding version ")
  ...
  var or,
    Se =
      'undefined' != typeof Symbol && 'observable' in Symbol ? Symbol.observable : '@@observable',
    ir =
        ...
        var f = function (e) {
          ...
          t = function () {
            ...
            !a &&
              ...
              })((n = { subscr: t, signal: i.signal, requery: l, querier: h, trans: null }))),
