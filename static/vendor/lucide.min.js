...
(function (a, n) {
  ...
  const n = {
    ...
    Uu = (t) => Array.from(t.attributes).reduce((h, d) => ((h[d.name] = d.value), h), {}),
    Ba = (t) =>
      typeof t == 'string'
        ? t
        : !t || !t.class
    ...
    Nc = [['path', { d: 'M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z' }]],
    Kc = [
      ['path', { d: 'M12 16h.01' }],
      ['path', { d: 'M16 16h.01' }],
      [
    ...
    U7 = [['path', { d: 'M18 22V2.8a.8.8 0 0 0-1.17-.71L5.45 7.78a.8.8 0 0 0 0 1.44L18 15.5' }]],
    ...
    Xp = [['path', { d: 'M6 16c5 0 7-8 12-8a4 4 0 0 1 0 8c-5 0-7-8-12-8a4 4 0 1 0 0 8' }]],
    jp = [
      ['circle', { cx: '12', cy: '12', r: '10' }],
      ['path', { d: 'M12 16v-4' }],
      ['path', { d: 'M12 8h.01' }],
    ...
    Fy = [['path', { d: 'M12 3c7.2 0 9 1.8 9 9s-1.8 9-9 9-9-1.8-9-9 1.8-9 9-9' }]],
    Dy = [
    ...
    zg = [['path', { d: 'M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z' }]],
    Fg = [
    ...
    if (
      ...
      M &&
        Array.from(c.querySelectorAll('template')).forEach((p) =>
          zu({ icons: t, nameAttr: h, attrs: d, root: p.content, inTemplates: M })
        ),
      h === 'data-lucide')
    ) {
